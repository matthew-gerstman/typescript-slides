...
<div style={{ fontSize: "3em" }}>bit.ly/broadway-book</div>
...
<img style={{ width: "80vw", background: "white" }} src="assets/trends.png" />
...
<Notes>Out of scope for this talk</Notes>

---

# Any

<Notes>Escape hatch</Notes>
...
<NotesList>
  <li>Brian is a Ravenclaw</li>
  <li>But his wife, Nikki is a Slytherin</li>
</NotesList>
...
<div style={{ fontSize: "3em" }}>bit.ly/ts-hoc</div>
...
<TallImage src="assets/definitely-typed.png" />
...
<TallImage src="assets/charles-bridge.gif" />
...
<div style={{ fontSize: "3em" }}>bit.ly/db-lodash</div>
...
<TallImage src="assets/taylor-swift.gif" />
...
<div>
  <ul style={{ fontSize: 24 }}>
    <li>
      <Emoji size="20px" name="typescript.jpg" />
      <a href="https://en.wikipedia.org/wiki/Data_type">
        https://en.wikipedia.org/wiki/Data_type
      </a>
    </li>
    <li>
      <Emoji size="20px" name="typescript.jpg" />
      <a href="https://blogs.dropbox.com/tech/2018/09/migrating-from-underscore-to-lodash">
        https://blogs.dropbox.com/tech/2018/09/migrating-from-underscore-to-lodash/
      </a>
    </li>
    <li>
      <Emoji size="20px" name="typescript.jpg" />
      <a href="https://twitter.com/MatthewGerstman/status/1087928519592722432?s=20">
        https://twitter.com/MatthewGerstman/status/1087928519592722432?s=20
      </a>
    </li>
    <li>
      <Emoji size="20px" name="typescript.jpg" />
      <a href="https://news.ycombinator.com/item?id=18975373">
        https://news.ycombinator.com/item?id=18975373
      </a>
    </li>
    <li>
      <Emoji size="20px" name="typescript.jpg" />
      <a href="https://medium.com/javascript-scene/the-typescript-tax-132ff4cb175b">
    ...
    <li>
      <Emoji size="20px" name="typescript.jpg" />
      <a href="https://medium.com/@jasvir/monoglots-when-a-subset-is-not-1604e3a51d9">
