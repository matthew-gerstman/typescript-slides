...
<h2>Problem: we want to test new React Versions in production but we shouldn't allow access to new features.</h2>
...
<CodeSurfer
  ...
  steps={[
    ...
    {range: [11, 14]},
    // Generic
    {tokens: {11: [9, 10, 11, 12], 14: [1]},lines: [12, 13]},
    // State
    {lines: [13]},
    {lines: [9]},
    {lines: [15]},
